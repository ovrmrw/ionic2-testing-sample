...
var buildBrowserify = require('./tests/_ionic_test/nightwatch/ionic-gulp-browserify-typescript-babel');
...
gulp.task('nightwatch',() => {
  gulp.src('')
    .pipe(plumber())
    .pipe(nightwatch({
      configFile: 'tests/_ionic_test/nightwatch/nightwatch.conf.js'
    }));
});
